...
int main() {
...
#ifdef __APPLE__
    std::cout << "Apple device is detected." << std::endl;
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        glBindVertexArray(vao);
        // glDrawArrays(GL_TRIANGLES, 0, 6);    // used when not using the element_buffer
